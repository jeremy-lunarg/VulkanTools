    ...
    : QGroupBox(tr("Active Layers"), parent)
{
    ...
    left_column_layout->addWidget(up_button, 1, 0);
    ...
    left_column_layout->addWidget(down_button, 2, 0);
    ...
    left_column_layout->addWidget(remove_button, 3, 0);
    ...
    left_column_layout->addWidget(clear_button, 4, 0);
    ...
    left_column_layout->addWidget(enabled_layer_list, 1, 1, 5, 1);
    left_column_layout->setRowStretch(5, 1);
